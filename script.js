document.addEventListener('DOMContentLoaded', function() {
  ...
  document.addEventListener('click', function(e) {
    if (e.target.matches('a[href^="#"]') || e.target.closest('a[href^="#"]')) {
      ...
      if (target) {
        ...
        const navbarHeight = document.querySelector('nav, .navbar, header')?.offsetHeight || 0;
  ...
  const animateElements = document.querySelectorAll('.fade-in, [data-animate], .animate-on-scroll');
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "DrSkin uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '3d6b8da6-1a4a-4d66-86fe-121e0a6a86d3',
                    name: data.name || '',
                    email: data.email || '',
